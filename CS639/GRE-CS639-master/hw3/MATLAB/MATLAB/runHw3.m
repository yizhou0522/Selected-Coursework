...
signAcademicHonestyPolicy('Yizhou Liu', 'liu773');
...
portrait_pts = [1 2; 325 2; 327 400; 3 399  ];
bg_pts = [101 20; 277 71; 286 424; 84 438];
...
% stitch three images
imgc = im2single(imread('l.jpg'));
imgl = im2single(imread('m.jpg'));
imgr = im2single(imread('r.jpg'));
...
%figure, imshow(stitched_img);
imwrite(stitched_img, 'whole_view_panorama.png');
