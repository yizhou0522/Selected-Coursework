...
%               get you started.
    ...
    for n = 1:num_imgs
        ...
        %
        [inliers_id,H]=runRANSAC(kp_n, kp_stitched,100,3);
        [mask,img_w]=backwardWarpImg(img_n,inv(H),[W_stitched,H_stitched]);
        stitched_img=blendImagePair(img_w, mask,stitched_img,stitch_mask,'blend');
